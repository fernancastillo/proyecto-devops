      ...
      <div className="mx-auto text-center ">
        ...
        <div className="mx-auto mt-10 grid max-w-lg grid-cols-4 items-center gap-x-8 gap-y-10 sm:max-w-xl sm:grid-cols-6 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-3">
          <img
            ...
            src="/img-proxy/A/apple-logo-E3DBF3AE34-seeklogo.com.png"
            alt="Transistor"
            width="158"
            height="48"
          />
          ...
          <img
            className="col-span-2 max-h-12 w-full object-contain lg:col-span-1 mx-auto"
            src="/img-proxy/H/hyper-x-logo-C4B6774A38-seeklogo.com.png"
            alt="Tuple"
            width="158"
            height="48"
          />
          <img
            ...
            src="/img-proxy/L/logitech-gaming-logo-B76FC713B0-seeklogo.com.png"
            alt="SavvyCal"
            width="158"
            height="48"
          />
